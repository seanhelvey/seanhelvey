...
I'm looking for my next role now, and I'd like it to be somewhere software helps people and the planet. Climate, social services, education, or public interest. Climate would be a return rather than a new direction, since I worked on energy market data at Genscape, utility customer engagement at Simple Energy, and built a smart thermostat at EnergyHub for my graduate capstone. I'm open to any awesome humans doing good things with tech. Please feel free to reach out!
...
- **On side projects:** FastAPI, SQLAlchemy, Supabase, Strawberry GraphQL, TypeScript, Go, numpy, sentence-transformers
...
- **[RAG from scratch](https://github.com/seanhelvey/rag-from-scratch/blob/main/rag.ipynb)** ([source](https://github.com/seanhelvey/rag-from-scratch)) is a notebook I put together to refresh my own understanding of retrieval-augmented generation, built up from numpy: dense search, BM25, rank fusion, and a cross-encoder reranker, checked against a small set of labelled questions. No framework, no API keys, runs offline on a laptop.
...
I like helping people feel welcome in communities. I founded [Central Coast Python](https://www.meetup.com/central-coast-python/), co-chaired contribution sprints at [DjangoCon US](https://djangocon.us/) in 2025, and co-organized BoulderJS before that. Earlier I spent two years as a lead instructor at Galvanize.

I'm a surfer, meditator, and permaculture practitioner. I earned a certification in [abundant food forests](https://oaec.org/our-work/resilient-community-design/permaculture-courses/food-forests-course/) at OAEC and completed a 200-hour yoga teacher training.

[me@seanhelvey.com](mailto:me@seanhelvey.com) · [seanhelvey.com](https://seanhelvey.com) · [LinkedIn](https://www.linkedin.com/in/seanhelvey/) · [Bluesky](https://bsky.app/profile/seanhelvey.bsky.social) · [Mastodon](https://mas.to/@seanhelvey) · [Goodreads](https://www.goodreads.com/user/show/39832025-sean-helvey)
